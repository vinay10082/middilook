        ...
        child: Center(
          child: Column(
            children: [
              ...
              Text('MIDDILOOK', style: TextStyle(fontSize: 34, color: Colors.pink, fontWeight: FontWeight.bold),),
              const SizedBox(height: 30,),

              Text('Create an account', style: TextStyle(fontSize: 20, color: Colors.white, fontWeight: FontWeight.bold),),
              const SizedBox(height: 30,),
              ...
              //username input
              InputTextWidget(textEditingController: userNameTextEditingController, lableString: 'User Name', iconData: Icons.person_4_outlined, isObscure: false,),
              
              const SizedBox(height: 30,),
              
              //email input
              InputTextWidget(textEditingController: emailTextEditingController, lableString: 'Email', iconData: Icons.email_outlined, isObscure: false,),

              const SizedBox(height: 30,),

              //password input
              InputTextWidget(textEditingController: passwordTextEditingController, lableString: 'Password', iconData: Icons.lock_outline, isObscure: true,),
